...
doctrack preview docs/ --port 8080
```
...
```bash
doctrack preview docs/ --port 3000
```
...
related sources:
- src/doctrack/commands/preview/ - preview module
- src/doctrack/core/git.py       - get_file_history, get_file_at_commit
